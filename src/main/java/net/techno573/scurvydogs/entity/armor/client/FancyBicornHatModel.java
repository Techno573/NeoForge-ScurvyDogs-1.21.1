...
public class FancyBicornHatModel extends GeoModel<HatItem> {
    @Override
    public ResourceLocation getModelResource(HatItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(ScurvyDogsMod.MOD_ID,"geo/armor/fancy_bicorn_hat.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(HatItem animatable) {
        return ResourceLocation.fromNamespaceAndPath(ScurvyDogsMod.MOD_ID,"textures/models/armor/bicorn_hat.png");
    }
